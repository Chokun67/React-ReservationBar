      ...
      <header>
        <nav>
          ...
          <ul className={menuOpen ? "open" : ""}>
            <li>
              {!signin ? <Link to="/admin/reserve">RESERVE</Link> : <Link onClick={()=>swalactive()}>RESERVE</Link>}
            </li>
            <li>
              {!signin ? <Link to="/admin/music">MUSIC</Link> : <Link onClick={()=>swalactive()}>MUSIC</Link>}
            </li>
            <li>
              {!signin ? <Link to="/admin/user">USER</Link> : <Link onClick={()=>swalactive()}>USER</Link>}
            </li>
          </ul>
          <div
